...
public class RoundExecutorTests
{
    ...
    public async Task NoToolCalls_IsFinal()
    {
        var r = await RoundExecutor.ExecuteOneRoundAsync(
            RoundResponse.Final("DONE", new TokenUsage()), new FakeExplorer(), (_, __) => { }, null, null, null, null, null, null, default);
    ...
    {
        var r = await RoundExecutor.ExecuteOneRoundAsync(
            RoundResponse.Tools(new[] { FC("get_board_overview", new { }) }), new FakeExplorer(), (_, __) => { }, null, null, null, null, null, null, default);
    ...
    public async Task ControlTool_CapturesControl_AndOpenCallId_KeepsExploreOutputs()
    {
        var r = await RoundExecutor.ExecuteOneRoundAsync(
            ...
            new FakeExplorer(), (_, __) => { }, null, null, null, null, null, null, default);
